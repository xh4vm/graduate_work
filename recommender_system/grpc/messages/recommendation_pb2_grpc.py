...
class RecommenderStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.get_recommendations = channel.unary_unary(
...
def add_RecommenderServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'get_recommendations': grpc.unary_unary_rpc_method_handler(
                    servicer.get_recommendations,
...
class Recommender(object):
    ...
    def get_recommendations(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/recommendation.Recommender/get_recommendations',
