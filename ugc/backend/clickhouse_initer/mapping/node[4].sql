...
Engine=ReplicatedMergeTree('/clickhouse/tables/shard1/movie_frame', 'replica4')
...
Engine=ReplicatedMergeTree('/clickhouse/tables/shard1/movie_viewed_time', 'replica4')
PARTITION BY toYYYYMMDD(created_at)
ORDER BY (id);
